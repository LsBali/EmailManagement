          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 text-muted-foreground">
                  ...
                  <span>3rd floor, YC-CIII, G- Building YCIS, Powai Naka, Satara - 415001</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 text-muted-foreground">
                  ...
                  <span>Monday - Friday: 9:00 AM - 04:00 PM</span>
                </div>
                <div className="flex items-center space-x-3 text-muted-foreground">
                  <div className="w-[18px]"></div>
                  <span>Saturday: 10:00 AM - 01:00 PM</span>
                </div>
                <div className="flex items-center space-x-3 text-muted-foreground">
                  <div className="w-[18px]"></div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our email-based leave application automates approvals and tracking, saving time, ensuring accuracy, and offering a seamless experience for employees and HR.
              </p>
